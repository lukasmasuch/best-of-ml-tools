...
- [IDEs & Notebook Editors](#ides--notebook-editors) _20 projects_
- [Machine Learning Platforms](#machine-learning-platforms) _12 projects_
...
- **[GitHub](https://github.com/atom/atom)** (👨‍💻 540 · 🔀 13K · 📥 4.6M · 📋 15K - 3% open · ⏱️ 11.11.2019):
...
- **[GitHub](https://github.com/eclipse-theia/theia)** (👨‍💻 130 · 🔀 780 · 📦 190 · 📋 3.8K - 31% open · ⏱️ 11.11.2019):
	...
	```
- **[NPM](https://www.npmjs.com/package/@theia/application-manager)** (📥 13K / month · 📦 94 · ⏱️ 06.11.2019):
...
- **[GitHub](https://github.com/cdr/code-server)** (👨‍💻 68 · 🔀 1.6K · 📥 130K · 📋 960 - 21% open · ⏱️ 07.11.2019):
	...
	```
- **[Dockerhub](https://hub.docker.com/r/codercom/code-server)** (📥 6.7M · ⭐ 120 · ⏱️ 07.11.2019):
...
<details><summary><b><a href="https://github.com/jupyter/docker-stacks">Jupyter Docker Stacks</a></b> (🥉24 ·  ⭐ 4.7K) - Ready-to-run Docker images containing Jupyter applications. <code><a href="https://tldrlegal.com/license/bsd-3-clause-license-(revised)">BSD-3</a></code></summary>

- **[GitHub](https://github.com/jupyter/docker-stacks)** (👨‍💻 150 · 🔀 1.7K · 📋 490 - 12% open · ⏱️ 09.11.2019):
...
- **[GitHub](https://github.com/NVIDIA/DIGITS)** (👨‍💻 48 · 🔀 1.3K · 📋 1.5K - 39% open · ⏱️ 05.11.2019):
...
- **[GitHub](https://github.com/apache/zeppelin)** (👨‍💻 380 · 🔀 2.1K · ⏱️ 11.11.2019):
	...
	```
- **[Dockerhub](https://hub.docker.com/r/apache/zeppelin)** (📥 810K · ⭐ 100 · ⏱️ 07.10.2019):
...
- **[GitHub](https://github.com/polynote/polynote)** (👨‍💻 15 · 🔀 210 · 📥 9.3K · 📋 290 - 38% open · ⏱️ 08.11.2019):

	```
	git clone https://github.com/polynote/polynote
	```
- **[Dockerhub](https://hub.docker.com/r/polynote/polynote)** (📥 360 · ⏱️ 08.11.2019):
...
- **[GitHub](https://github.com/apache/mahout)** (👨‍💻 57 · 🔀 910 · 📦 55 · ⏱️ 12.11.2019):
...
- **[Conda](https://anaconda.org/conda-forge/singa-cpu)**:
	...
	```
- **[Dockerhub](https://hub.docker.com/r/apache/singa)** (📥 110 · ⭐ 2 · ⏱️ 04.06.2019):
...
- **[GitHub](https://github.com/metabase/metabase)** (👨‍💻 220 · 🔀 2.3K · 📥 1K · 📦 1 · 📋 6.4K - 32% open · ⏱️ 11.11.2019):

	```
	git clone https://github.com/metabase/metabase
	```
- **[Dockerhub](https://hub.docker.com/r/metabase/metabase)** (📥 28M · ⭐ 150 · ⏱️ 09.11.2019):
...
- **[PyPi](https://pypi.org/project/apache-superset)** (📥 620 / month · ⏱️ 18.09.2019):
	...
	```
- **[Dockerhub](https://hub.docker.com/r/amancevice/superset)** (📥 1.2M · ⭐ 210 · ⏱️ 09.11.2019):
...
- **[GitHub](https://github.com/cloudera/hue)** (👨‍💻 220 · 🔀 1.5K · 📦 3 · 📋 700 - 28% open · ⏱️ 09.11.2019):
...
- **[GitHub](https://github.com/distribworks/dkron)** (👨‍💻 42 · 🔀 190 · 📥 260K · 📋 320 - 10% open · ⏱️ 11.11.2019):

	```
	git clone https://github.com/distribworks/dkron
	```
- **[Dockerhub](https://hub.docker.com/r/dkron/dkron)** (📥 480K · ⭐ 10 · ⏱️ 10.10.2019):
...
- **[GitHub](https://github.com/apache/incubator-dolphinscheduler)** (👨‍💻 51 · 🔀 850 · 📥 3.9K · 📋 510 - 46% open · ⏱️ 01.11.2019):
...
<details><summary><b><a href="https://github.com/azkaban/azkaban">Azkaban</a></b> (🥉20 ·  ⭐ 2.9K) - Batch workflow job scheduler created at LinkedIn to run Hadoop jobs. <code><a href="https://tldrlegal.com/license/apache-license-2.0-(apache-2.0)">Apache-2</a></code></summary>
...
<details><summary><b><a href="https://github.com/mcuadros/ofelia">Ofelia</a></b> (🥉19 ·  ⭐ 1.1K) - A docker job scheduler (aka. crontab for docker). <code><a href="https://tldrlegal.com/license/mit-license">MIT</a></code></summary>

- **[GitHub](https://github.com/mcuadros/ofelia)** (👨‍💻 15 · 🔀 78 · 📥 8.2K · 📋 59 - 57% open · ⏱️ 06.11.2019):

	```
	git clone https://github.com/mcuadros/ofelia
	```
- **[Dockerhub](https://hub.docker.com/r/mcuadros/ofelia)** (📥 2.1M · ⭐ 14 · ⏱️ 06.11.2019):
...
- **[GitHub](https://github.com/prisma/prisma)** (👨‍💻 250 · 🔀 910 · 📦 5.6K · 📋 3.4K - 18% open · ⏱️ 11.11.2019):
	...
	```
- **[NPM](https://www.npmjs.com/package/prisma-client-lib)** (📥 130K / month · 📦 490 · ⏱️ 14.06.2019):
...
- **[GitHub](https://github.com/apache/hive)** (👨‍💻 350 · 🔀 2.4K · 📦 9 · ⏱️ 11.11.2019):
	...
	```
- **[PyPi](https://pypi.org/project/pyhive)** (📥 1M / month · 📦 740 · ⏱️ 10.09.2018):
...
- **[GitHub](https://github.com/prestodb/presto)** (👨‍💻 440 · 🔀 3.4K · 📦 1 · 📋 4K - 24% open · ⏱️ 11.11.2019):
	...
	```
- **[PyPi](https://pypi.org/project/presto-python-client)** (📥 250K / month · ⏱️ 16.04.2019):

	```
	pip install presto-python-client
	```
- **[NPM](https://www.npmjs.com/package/presto-client)** (📥 2.5K / month · 📦 22 · ⏱️ 09.04.2019):
...
- **[GitHub](https://github.com/Alluxio/alluxio)** (👨‍💻 1.2K · 🔀 2.2K · 📥 20K · 📦 1 · 📋 520 - 38% open · ⏱️ 11.11.2019):
...
- **[GitHub](https://github.com/apache/nifi)** (👨‍💻 350 · 🔀 1.5K · ⏱️ 11.11.2019):
...
- **[NPM](https://www.npmjs.com/package/tika)** (📥 880 / month · 📦 28 · ⏱️ 22.02.2017):
	...
	npm install tika
	```
- **[Dockerhub](https://hub.docker.com/r/logicalspark/docker-tikaserver)** (📥 980K · ⭐ 26 · ⏱️ 04.08.2019):
...
<details><summary><b><a href="https://github.com/apache/drill">Drill</a></b> (🥉25 ·  ⭐ 1.3K) - Schema-free SQL Query Engine for Hadoop, NoSQL and Cloud Storage. <code><a href="https://tldrlegal.com/license/apache-license-2.0-(apache-2.0)">Apache-2</a></code></summary>

- **[GitHub](https://github.com/apache/drill)** (👨‍💻 170 · 🔀 730 · 📦 14 · ⏱️ 06.11.2019):
...
- **[PyPi](https://pypi.org/project/pydrill)** (📥 820 / month · 📦 3 · ⏱️ 24.04.2018):
	...
	pip install pydrill
	```
- **[Dockerhub](https://hub.docker.com/r/drill/apache-drill)** (📥 29K · ⭐ 8 · ⏱️ 07.05.2019):
...
- **[GitHub](https://github.com/streamsets/datacollector)** (👨‍💻 92 · 🔀 440 · ⏱️ 11.11.2019):
	...
	```
- **[PyPi](https://pypi.org/project/streamsets)** (📥 520 / month · ⏱️ 25.10.2019):

	```
	pip install streamsets
	```
- **[Dockerhub](https://hub.docker.com/r/streamsets/datacollector)** (📥 1.6M · ⭐ 52 · ⏱️ 10.11.2019):
...
- **[GitHub](https://github.com/scality/Zenko)** (👨‍💻 38 · 🔀 46 · 📥 250 · 📋 43 - 25% open · ⏱️ 07.11.2019):
	...
	```
- **[Dockerhub](https://hub.docker.com/r/zenko/cloudserver)** (📥 3.5M · ⭐ 10 · ⏱️ 08.11.2019):
...
- **[GitHub](https://github.com/bloomreach/s4cmd)** (👨‍💻 30 · 🔀 150 · 📦 2 · 📋 110 - 57% open · ⏱️ 03.04.2019):
...
- **[GitHub](https://github.com/apache/sqoop)** (👨‍💻 39 · 🔀 410 · ⏱️ 16.10.2019):
	...
	```
- **[PyPi](https://pypi.org/project/pysqoop)** (📥 230 / month · ⏱️ 26.10.2019):
...
- **[GitHub](https://github.com/apache/flink)** (👨‍💻 860 · 🔀 5.8K · 📦 100 · ⏱️ 11.11.2019):
	...
	```
- **[Dockerhub](https://hub.docker.com/r/_/flink)** (📥 43M · ⭐ 130 · ⏱️ 29.10.2019):
...
<details><summary><b><a href="https://github.com/wkentaro/labelme">Labelme</a></b> (🥇24 ·  ⭐ 3.5K) - Image Polygonal Annotation with Python (polygon, rectangle, circle, line,.. <code><a href="https://tldrlegal.com/license/gnu-general-public-license-v3-(gpl-3)">❗️GPL-3.0</a></code></summary>
...
- **[GitHub](https://github.com/heartexlabs/label-studio)** (👨‍💻 11 · 🔀 100 · 📥 1 · 📦 1 · 📋 34 - 32% open · ⏱️ 11.11.2019):
	...
	```
- **[NPM](https://www.npmjs.com/package/label-studio)** (📥 290 / month · ⏱️ 16.10.2019):
...
<details><summary><b><a href="https://github.com/Hitachi-Automotive-And-Industry-Lab/semantic-segmentation-editor">Semantic Segmentation Editor</a></b> (🥉15 ·  ⭐ 460) - Web labeling tool for camera and LIDAR data. <code><a href="https://tldrlegal.com/license/mit-license">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/SkalskiP/make-sense">makesense.ai</a></b> (🥉12 ·  ⭐ 870 · 🐣) - Free to use online tool for labelling photos. https://makesense.ai. <code><a href="https://tldrlegal.com/license/gnu-general-public-license-v3-(gpl-3)">❗️GPL-3.0</a></code></summary>
...
<details><summary><b><a href="https://github.com/grafana/grafana">Grafana</a></b> (🥇33 ·  ⭐ 33K) - The tool for beautiful monitoring and metric analytics & dashboards for.. <code><a href="https://tldrlegal.com/license/apache-license-2.0-(apache-2.0)">Apache-2</a></code></summary>
...
- **[GitHub](https://github.com/elastic/kibana)** (👨‍💻 480 · 🔀 5.2K · 📦 5 · 📋 20K - 27% open · ⏱️ 11.11.2019):
	...
	```
- **[Dockerhub](https://hub.docker.com/r/_/kibana)** (📥 72M · ⭐ 1.6K · ⏱️ 01.11.2019):
...
- **[GitHub](https://github.com/facette/facette)** (👨‍💻 29 · 🔀 76 · 📥 5.7K · 📋 340 - 10% open · ⏱️ 10.08.2019):
...
- **[GitHub](https://github.com/influxdata/chronograf)** (👨‍💻 76 · 🔀 190 · 📋 3.6K - 17% open · ⏱️ 08.11.2019):
...
<details><summary><b><a href="https://github.com/HarisIqbal88/PlotNeuralNet">PlotNeuralNet</a></b> (🥉15 ·  ⭐ 6.8K) - Latex code for making neural networks diagrams. <code><a href="https://tldrlegal.com/license/mit-license">MIT</a></code></summary>

- **[GitHub](https://github.com/HarisIqbal88/PlotNeuralNet)** (👨‍💻 8 · 🔀 910 · 📋 59 - 67% open · ⏱️ 30.07.2019):
...
<details><summary>Show 1 hidden projects...</summary>
<br><details><summary><b><a href="https://github.com/bhoov/exbert">exBERT</a></b> (🥉8 ·  ⭐ 100 · 🐣) - A Visual Analysis Tool to Explore Learned Representations in Transformers.. <code><a href="https://tldrlegal.com/license/apache-license-2.0-(apache-2.0)">Apache-2</a></code></summary>
...
- **[GitHub](https://github.com/microsoft/onnxruntime)** (👨‍💻 120 · 🔀 300 · 📥 4.3K · 📦 100 · 📋 600 - 22% open · ⏱️ 11.11.2019):
...
- **[GitHub](https://github.com/jolibrain/deepdetect)** (👨‍💻 22 · 🔀 470 · 📋 350 - 16% open · ⏱️ 31.10.2019):
	...
	```
- **[Dockerhub](https://hub.docker.com/r/jolibrain/deepdetect_cpu)** (📥 18K · ⏱️ 10.11.2019):
...
- **[GitHub](https://github.com/bentoml/BentoML)** (👨‍💻 8 · 🔀 72 · 📥 53 · 📦 6 · 📋 60 - 11% open · ⏱️ 11.11.2019):

	```
	git clone https://github.com/bentoml/bentoml
	```
- **[PyPi](https://pypi.org/project/bentoml)** (📥 880 / month · 📦 4 · ⏱️ 11.11.2019):
...
<details><summary><b><a href="https://github.com/junyanz/interactive-deep-colorization">Deep Colorization</a></b> (🥉14 ·  ⭐ 2K) - Deep learning software for colorizing black and white images with a few.. <code><a href="https://tldrlegal.com/license/mit-license">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/cython/cython">Cython</a></b> (🥇36 ·  ⭐ 4.7K) - The most widely used Python to C compiler. <code><a href="https://tldrlegal.com/license/apache-license-2.0-(apache-2.0)">Apache-2</a></code></summary>
...
- **[GitHub](https://github.com/intel/mkl-dnn)** (👨‍💻 100 · 🔀 400 · 📥 1.8M · 📋 510 - 3% open · ⏱️ 11.11.2019):
...
<details><summary><b><a href="https://github.com/NVIDIA/TensorRT">TensorRT</a></b> (🥉17 ·  ⭐ 1.5K · 🐣) - TensorRT is a C++ library for high performance inference on NVIDIA GPUs.. <code><a href="https://tldrlegal.com/license/apache-license-2.0-(apache-2.0)">Apache-2</a></code></summary>
...
- **[PyPi](https://pypi.org/project/pymongo)** (📥 4.9M / month · 📦 33K · ⏱️ 14.08.2019):
	...
	pip install pymongo
	```
- **[NPM](https://www.npmjs.com/package/mongodb)** (📥 5.6M / month · 📦 220K · ⏱️ 11.11.2019):
...
- **[NPM](https://www.npmjs.com/package/pg)** (📥 3.9M / month · 📦 84K · ⏱️ 09.08.2019):
	...
	npm install pg
	```
- **[Dockerhub](https://hub.docker.com/r/_/postgres)** (📥 1.7B · ⭐ 7.2K · ⏱️ 22.10.2019):
...
<details><summary><b><a href="https://github.com/antirez/redis">Redis</a></b> (🥇36 ·  ⭐ 47K) - Redis is an in-memory database that persists on disk. The data model is key-value,.. <code><a href="https://tldrlegal.com/license/bsd-3-clause-license-(revised)">BSD-3</a></code></summary>
...
- **[NPM](https://www.npmjs.com/package/neo4j-driver)** (📥 81K / month · 📦 900 · ⏱️ 04.11.2019):
	...
	```
- **[Dockerhub](https://hub.docker.com/r/_/neo4j)** (📥 62M · ⭐ 730 · ⏱️ 01.11.2019):
...
- **[PyPi](https://pypi.org/project/pyarrow)** (📥 4.9M / month · 📦 800 · ⏱️ 01.11.2019):
	...
	pip install pyarrow
	```
- **[NPM](https://www.npmjs.com/package/apache-arrow)** (📥 3.4K / month · 📦 22 · ⏱️ 01.11.2019):
...
- **[GitHub](https://github.com/etcd-io/etcd)** (👨‍💻 610 · 🔀 5.8K · 📥 21M · 📋 4.7K - 11% open · ⏱️ 11.11.2019):
	...
	```
- **[PyPi](https://pypi.org/project/etcd3)** (📥 100K / month · 📦 36 · ⏱️ 10.04.2019):
...
<details><summary><b><a href="https://github.com/apache/hbase">HBase</a></b> (🥈33 ·  ⭐ 3.2K) - Non-relational distributed database modeled after Google's Bigtable and written.. <code><a href="https://tldrlegal.com/license/apache-license-2.0-(apache-2.0)">Apache-2</a></code></summary>
...
- **[PyPi](https://pypi.org/project/rethinkdb)** (📥 20K / month · 📦 870 · ⏱️ 02.11.2019):
	...
	```
- **[NPM](https://www.npmjs.com/package/rethinkdb)** (📥 34K / month · 📦 3.1K · ⏱️ 29.08.2016):
...
<details><summary><b><a href="https://github.com/orientechnologies/orientdb">OrientDB</a></b> (🥈32 ·  ⭐ 4.1K) - OrientDB is the most versatile DBMS supporting Graph, Document, Reactive,.. <code><a href="https://tldrlegal.com/license/apache-license-2.0-(apache-2.0)">Apache-2</a></code></summary>
...
- **[NPM](https://www.npmjs.com/package/arangojs)** (📥 21K / month · 📦 420 · ⏱️ 30.08.2019):
	...
	```
- **[Dockerhub](https://hub.docker.com/r/_/arangodb)** (📥 16M · ⭐ 170 · ⏱️ 09.11.2019):
...
- **[GitHub](https://github.com/graphite-project/graphite-web)** (👨‍💻 410 · 🔀 1.2K · 📦 45 · 📋 1.1K - 33% open · ⏱️ 11.11.2019):
	...
	```
- **[Dockerhub](https://hub.docker.com/r/graphiteapp/graphite-statsd)** (📥 6.4M · ⭐ 69 · ⏱️ 24.10.2019):
...
- **[GitHub](https://github.com/dgraph-io/dgraph)** (👨‍💻 120 · 🔀 790 · 📥 110K · 📋 1.8K - 8% open · ⏱️ 07.11.2019):
...
- **[GitHub](https://github.com/apache/geode)** (👨‍💻 170 · 🔀 540 · ⏱️ 11.11.2019):
	...
	```
- **[Dockerhub](https://hub.docker.com/r/apachegeode/geode)** (📥 57K · ⭐ 18 · ⏱️ 23.10.2019):

	```
	docker pull apachegeode/geode
	```
- **[Maven](https://search.maven.org/artifact/org.apache.geode/geode-core)** (📦 110 · ⏱️ 19.04.2019):
...
- **[PyPi](https://pypi.org/project/pymapd)** (📥 2.2K / month · 📦 15 · ⏱️ 01.11.2019):
	...
	pip install pymapd
	```
- **[NPM](https://www.npmjs.com/package/@mapd/connector)** (📥 130 / month · 📦 26 · ⏱️ 22.08.2019):
...
- **[PyPi](https://pypi.org/project/pyley)** (📥 180 / month · ⏱️ 26.10.2019):
	...
	pip install pyley
	```
- **[NPM](https://www.npmjs.com/package/@cayleygraph/cayley)** (📥 200 / month · ⏱️ 06.11.2019):
...
- **[PyPi](https://pypi.org/project/riak)** (📥 7.9K / month · 📦 170 · ⏱️ 12.12.2016):
	...
	pip install riak
	```
- **[NPM](https://www.npmjs.com/package/basho-riak-client)** (📥 700 / month · 📦 60 · ⏱️ 12.12.2016):
...
- **[GitHub](https://github.com/tidwall/tile38)** (👨‍💻 36 · 🔀 360 · 📥 38K · 📋 390 - 20% open · ⏱️ 05.11.2019):
	...
	```
- **[Dockerhub](https://hub.docker.com/r/tile38/tile38)** (📥 640K · ⭐ 14 · ⏱️ 05.11.2019):
...
- **[GitHub](https://github.com/quiltdata/quilt)** (👨‍💻 27 · 🔀 47 · 📦 14 · 📋 98 - 57% open · ⏱️ 11.11.2019):
...
- **[GitHub](https://github.com/apache/incubator-doris)** (👨‍💻 63 · 🔀 370 · 📋 650 - 35% open · ⏱️ 11.11.2019):
	...
	```
- **[Dockerhub](https://hub.docker.com/r/apachedoris/doris-dev)** (📥 1K · ⭐ 4 · ⏱️ 19.10.2019):
...
- **[GitHub](https://github.com/edgedb/edgedb)** (👨‍💻 16 · 🔀 75 · 📋 270 - 26% open · ⏱️ 11.11.2019):
...
- **[PyPi](https://pypi.org/project/edgedb)** (📥 430 / month · ⏱️ 11.04.2019):
	...
	pip install edgedb
	```
- **[Dockerhub](https://hub.docker.com/r/edgedb/edgedb)** (📥 590 · ⭐ 2 · ⏱️ 17.10.2019):
...
<details><summary><b><a href="https://github.com/MariaDB/server">MariaDB</a></b> (🥉27 ·  ⭐ 6.2K) - MariaDB server is a community developed fork of MySQL server. Started by core.. <code><a href="https://tldrlegal.com/license/gnu-general-public-license-v2">❗️GPL-2.0</a></code></summary>
...
- **[NPM](https://www.npmjs.com/package/mariadb)** (📥 33K / month · 📦 160 · ⏱️ 19.07.2017):
	...
	npm install mariadb
	```
- **[Dockerhub](https://hub.docker.com/r/_/mariadb)** (📥 930M · ⭐ 3.1K · ⏱️ 01.11.2019):
...
- **[GitHub](https://github.com/ravendb/ravendb)** (👨‍💻 320 · 🔀 690 · 📦 2.1K · ⏱️ 11.11.2019):
	...
	```
- **[PyPi](https://pypi.org/project/pyravendb)** (📥 290 / month · 📦 2 · ⏱️ 27.02.2019):
...
- **[GitHub](https://github.com/appbaseio/dejavu)** (👨‍💻 18 · 🔀 370 · 📋 280 - 10% open · ⏱️ 28.10.2019):
	...
	```
- **[Dockerhub](https://hub.docker.com/r/appbaseio/dejavu)** (📥 990K · ⭐ 23 · ⏱️ 28.10.2019):
...
- **[GitHub](https://github.com/OmniDB/OmniDB)** (👨‍💻 19 · 🔀 220 · 📥 6K · 📋 470 - 36% open · ⏱️ 25.09.2019):
...
<details><summary><b><a href="https://github.com/huggingface/Mongoku">Mongoku</a></b> (🥉19 ·  ⭐ 750) - The Web-scale GUI for MongoDB. <code><a href="https://tldrlegal.com/license/mit-license">MIT</a></code></summary>
...
- **[GitHub](https://github.com/Alecaddd/sequeler)** (👨‍💻 33 · 🔀 47 · 📋 210 - 20% open · ⏱️ 01.09.2019):
...
- **[GitHub](https://github.com/mickael-kerjean/filestash)** (👨‍💻 17 · 🔀 110 · 📥 190 · 📋 180 - 14% open · ⏱️ 11.11.2019):
	...
	```
- **[Dockerhub](https://hub.docker.com/r/machines/filestash)** (📥 290K · ⭐ 6 · ⏱️ 07.11.2019):
...
- **[GitHub](https://github.com/ApolloAuto/apollo)** (👨‍💻 290 · 🔀 5.2K · 📥 34K · 📋 2K - 23% open · ⏱️ 11.11.2019):
	...
	```
- **[Dockerhub](https://hub.docker.com/r/apolloauto/apollo)** (📥 1.7M · ⭐ 34 · ⏱️ 11.11.2019):
...
- **[GitHub](https://github.com/scrapinghub/portia)** (👨‍💻 50 · 🔀 1.1K · 📥 110 · 📦 8 · 📋 430 - 22% open · ⏱️ 10.07.2019):
	...
	```
- **[PyPi](https://pypi.org/project/slybot)** (📥 340 / month · 📦 7 · ⏱️ 28.06.2017):
...
- **[GitHub](https://github.com/OpenRefine/OpenRefine)** (👨‍💻 130 · 🔀 1.1K · 📥 890K · 📋 1.6K - 26% open · ⏱️ 10.11.2019):
	...
	```
- **[Dockerhub](https://hub.docker.com/r/vimagick/openrefine)** (📥 73K · ⭐ 8 · ⏱️ 09.11.2019):
...
- **[PyPi](https://pypi.org/project/kylinpy)** (📥 540 / month · ⏱️ 07.04.2019):
	...
	pip install kylinpy
	```
- **[Dockerhub](https://hub.docker.com/r/apachekylin/apache-kylin-standalone)** (📥 1K · ⭐ 1 · ⏱️ 28.08.2019):
...
<details><summary><b><a href="https://github.com/kubeflow/katib">Katib</a></b> (🥉19 ·  ⭐ 560) - Repository for hyperparameter tuning. <code><a href="https://tldrlegal.com/license/apache-license-2.0-(apache-2.0)">Apache-2</a></code></summary>
...
<details><summary><b><a href="https://github.com/perone/euclidesdb">EuclidesDB</a></b> (🥉15 ·  ⭐ 550) - A multi-model machine learning feature embedding database. <code><a href="https://tldrlegal.com/license/apache-license-2.0-(apache-2.0)">Apache-2</a></code></summary>

- **[GitHub](https://github.com/perone/euclidesdb)** (👨‍💻 2 · 🔀 25 · 📥 200 · 📦 1 · 📋 22 - 50% open · ⏱️ 15.09.2019):
...
- **[PyPi](https://pypi.org/project/euclides)** (📥 180 / month · ⏱️ 12.02.2019):
	...
	```
- **[Dockerhub](https://hub.docker.com/r/euclidesdb/euclidesdb)** (📥 180 · ⭐ 1 · ⏱️ 12.02.2019):
